...
@section('title','Add Earrings | '. env('APP_NAME'))
@section('content')

   <div class="d-flex justify-content-between">
         <h1 class="h3 mb-4 text-dark-800 ml-4"> Add New Earrings</h1>
        <a href="{{route('dashboard.earrings.index')}}" class="btn  mb-4 mr-3"style="background-color: #834703;color: white;">All Earrings</a>
        </div>
        <div class="card">
            <div class="card-body">
                <form action="{{route('dashboard.earrings.store')}}" method="POST" enctype="multipart/form-data">
                                     @if($errors->any())
