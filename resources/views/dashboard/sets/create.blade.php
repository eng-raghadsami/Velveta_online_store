...
@section('title','Add Accessories sets | '. env('APP_NAME'))
@section('content')

   <div class="d-flex justify-content-between">
         <h1 class="h3 mb-4 text-dark-800 ml-4"> Add New Set</h1>
        <a href="{{route('dashboard.sets.index')}}" class="btn  mb-4 mr-3"style="background-color: #834703;color: white;">All Sets</a>
        </div>
        <div class="card">
            <div class="card-body">
                <form action="{{route('dashboard.sets.store')}}" method="POST" enctype="multipart/form-data">
                                     @if($errors->any())
