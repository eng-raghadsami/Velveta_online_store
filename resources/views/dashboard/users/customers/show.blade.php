...
<div class="d-flex justify-content-between">
   <h1 class="h3 mb-4 text-dark-800">{{ __('websit.navbar.customer') }} : <span class="text-danger">{{$user->trans_name}}</span>  </h1>
   <a href="{{route('dashboard.customers.index')}}" class="btn btn-danger mb-4 ">{{ __('websit.navbar.allcustomers') }}</a>
           </div>
